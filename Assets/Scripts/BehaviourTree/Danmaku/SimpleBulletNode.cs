...
public class SimpleBulletNode: BTActionNode
{
    ...
    [HideInInspector]public string angle, speed, aim, maxSpeed, acceleration, rotation;
    [Danmaku.BehaviourTree.CreateInputPort] public float _angle, _speed, _aim, _maxSpeed, _acceleration, _rotation;
